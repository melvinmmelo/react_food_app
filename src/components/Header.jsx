        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "melvin.melo@ub.edu.ph" && (
                  <Link to={"/createItem"}>
        ...
        <div className="relative">
          ...
          {isMenu && (
            <motion.div
              ...
              className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0"
            >
              {user && user.email === "melvinmmelo@gmail.com" && (
                <Link to={"/createItem"}>
                  <p className="px-4 py-2 flex items-center cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base" onClick={() => setIsMenu(false)}>
                    New Item <MdAdd />
                  </p>
                </Link>
              )}
