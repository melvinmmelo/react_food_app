    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      <div className="py-2 flex-1 flex flex-col items-start md:items-start justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          ...
          vitae ipsum incidunt cupiditate illo iste beatae nulla eligendi
          expedita id quam sed porro similique, sint numquam facere alias?
          Sapiente.
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:32px py-4 gap-4 flex-wrap">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
              ...
              >
                ...
                <p className="text-sm text-lighttextGray font-semibold lg:my-3">
                  {n.desc}
                </p>
